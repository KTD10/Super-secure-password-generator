...
function generatePassword(){
  ...
  var userWantsLowercase = window.confirm("Include lowercase letters in password?")
  var userWantsUppercase = window.confirm("Include uppercase letters in password?")
